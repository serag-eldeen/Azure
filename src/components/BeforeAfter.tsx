...
export default function BeforeAfter() {
  ...
  const beforeImages = [
    'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?auto=format&fit=crop&q=80&w=800&h=500&blur=3', // Teeth workspace close up
    'https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&q=80&w=800&h=500&blur=3'  // Medical consultation desk
  ];

  const afterImages = [
    'https://images.unsplash.com/photo-1606811971618-4486d14f3f99?auto=format&fit=crop&q=80&w=800&h=500', // Breathtaking white dental cosmetic case result
    'https://images.unsplash.com/photo-1598256989800-fe5f95da9787?auto=format&fit=crop&q=80&w=800&h=500'  // Healthy dental smile alignment
  ];
